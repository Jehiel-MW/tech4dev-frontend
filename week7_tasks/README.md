...
# IVAN IS 18 YEARS OLD AND RECEIVES AN INHERITANCE THAT CONSISTS OF X AMOUNT OF MONEY AND A TIME MACHINE. HE DECIDES TO RETURN TO 1800, BUT DOES NOT KNOW IF THE MONEY WILL BE ENOUGH TO LIVE WITHOUT WORKING. WRITE A PROGRAM THAT CALCULATES IF IVAN WILL HAVE ENOUGH MONEY TO NOT HAVE TO WORK UNTIL A PARTICULAR YEAR(INCLUSIVE). ASSUMING THAT FOR EVERY EVEN(1800,1802,ETC.) YEAR HE WILL SPEND 12000 DOLLARS.FOR EVERY ODD ONE(1801, 1803,ETC.) HE WILL SPEND 12000+50 * [THE AGE HE WILL HAVE REACHED IN THE GIVEN YEAR].
